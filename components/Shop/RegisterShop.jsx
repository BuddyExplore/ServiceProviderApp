...
import RegisterShopStep1 from './RegisterShopStep1';




export default function RegisterShop({ vehicleInfo , visibility , closeModal}) {
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.headerTxt}>  Register shop</Text>
