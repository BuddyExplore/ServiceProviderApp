...
export default function OptionsList() {
  const preferencesList = [
    {
      name: "Total Rooms",
      icon: <FontAwesome name="hotel" size={32} color="#0A89FF" />,
    ...
    {
      name: "Checked In",
      icon: <FontAwesome6 name="check-circle" size={32} color="green" />,
      subText: "Peak check-in time: 3 - 5 PM",
      count: 5,
      path: "../bookings/CheckedIn",
    },
    ...
    {
      name: "Total Bookings",
      icon: <Ionicons name="people" size={32} color="#C70039" />,
      subText: "In the past 7 days",
      count: 18,
      path: "../bookings/Bookings",
    },
    {
      name: "Reviews",
      icon: <MaterialIcons name="reviews" size={32} color="#FFC107" />,
